...
**Status:** **Implemented** 2026-08-02. RFC-015 carries a reciprocal amendment note, the release
checklist states that it owns *whether* and this policy owns *when*, and org §6.4 now runs the
readiness check mechanically against these triggers. Governance editing, so no Developer Handoff
(see `accepted/README.md`). No version, no release
