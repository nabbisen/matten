...
**Status:** Reviewed and accepted (GO, conditional on two mechanical handoff corrections, both applied); implemented on the `0.38.x` line; no version bump or release authorized
