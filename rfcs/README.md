...
| ID | Title | Handoff |
|---:|---|---|
| 093 | [Browser Shape Playground](./accepted/093-browser-shape-playground.md) — interactive shape/broadcast/reduction page in the deployed book, WebAssembly core, no published-crate change | [handoff](./handoffs/093-browser-shape-playground-handoff.md) |
