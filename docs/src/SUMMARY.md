...
- [Readiness checklist](./migration/readiness-checklist.md)
- [Readiness report template](./migration/readiness-report.md)
  - [Worked example: linear regression (GD)](./migration/examples/linear-regression-gd-readiness.md)
