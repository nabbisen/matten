...
The **v0.29 prerelease family** adds RFC-063 visual-understanding work: Markdown / ASCII diagrams
...
and the local-only `tools/matten-report` Markdown/plain-text report tool. These prereleases do not
