...
> **Production-ready candidate (`0.43.x` family).** A companion crate (RFC-078), promoted
...
- **SemVer:** pre-1.0 (`0.x`). A `0.x` minor bump may break and carries
  ...
  explicitly (`matten-stats = "0.43.0"`).
- **MSRV:** Rust 1.85 (edition 2024).
- **`matten`:** released with the `0.43.x` family version (RFC-030). The
