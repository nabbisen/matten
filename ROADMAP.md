...
**Document Version:** `1.86.0`
**Date:** 2026-07-17
**Status:** Canonical roadmap updated with proposed RFC-070, an audit-only public visualization/report readiness decision gate. RFC-070 opens the public `matten-report` / `matten-viz` readiness question without authorizing implementation, public crates, public renderer APIs, JSON/SVG/Vega-Lite output, core visualization APIs, dependency changes, version bump, release prep, tag, or publish.
...
| **Post-v0.36.0** | Public visualization/report readiness | RFC-070 proposed as audit-only decision gate for public `matten-report` / `matten-viz`; no implementation or public crate authorized | Audit / planning |
