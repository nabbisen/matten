...
| **Post-v0.37.0** | RFC-070 closure and report-tool maintainability | RFC-070 closed without a public report/viz surface; RFC-072 modularization and structural closure implemented, reviewed, and closed | Completed internal maintainability work |
