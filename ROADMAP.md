...
| **Post-v0.37.0** | Report-tool policy and maintainability | RFC-070 public-readiness audit and RFC-072 modularization closed; RFC-073 private input-mode JSON implementation prepared for review; release undecided | Implementation review checkpoint |
