...
**Date:** 2026-07-22
**Status:** `0.37.0` is released with the RFC-071 fixed-demo private JSON report slice. RFC-070 is closed without a public report/viz crate or API. RFC-072 Slice 0/1, Phase 2, and Phase 3A/B shared plus Markdown extraction are reviewed and committed. Phase 3C HTML extraction is implemented and prepared for review: shared document/escaping primitives and all five family owners, including bounded input-mode data-readiness, now live under `render::html` with their exact and security tests. All 59 tests and the 404-byte process fingerprint remain unchanged. Private JSON extraction and structural closure remain unauthorized until this HTML checkpoint is reviewed and committed. Input-mode JSON, broader mathematics, ecosystem bridges, public schemas, public renderer APIs, and public report/viz crates remain unauthorized.
...
| **Post-v0.37.0** | RFC-070 closure and report-tool maintainability | RFC-070 closed without a public report/viz surface; RFC-072 through Phase 3B committed; Phase 3C HTML extraction prepared for review | Implementation checkpoint |
...
committed. Phase 3C moves shared HTML document/security helpers and every HTML
family/test owner; it is implemented and prepared for review before private
JSON extraction.
