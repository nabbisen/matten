...
**Document Version:** `1.60.0`
**Date:** 2026-07-13
**Status:** Canonical roadmap updated for the v0.31.0 RFC-066/RFC-067 policy-cleanup release after the v0.30.0 educational-visualization release, docs-governance completion, RFC-049 lifecycle closure, and RFC-054 lifecycle closure. RFC-066 and RFC-067 do not authorize a v1.0 release, version bump, tag, publish, API change, dependency change, or companion promotion.
