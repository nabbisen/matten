...
| **Post-v0.36.0** | Public visualization/report readiness | RFC-070 readiness audit drafted: public `matten-report` / `matten-viz` not ready; JSON schema policy or private report-model extraction are possible future prerequisites | Audit / planning |
