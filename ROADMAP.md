...
**Date:** 2026-07-13
**Status:** Canonical roadmap updated after the v0.31.0 RFC-066/RFC-067 policy-cleanup release to open RFC-068 as the active proposed visualization-next theme. RFC-068 targets a local-only richer artifact phase for `tools/matten-report`; it does not authorize public report/viz crates, core visualization APIs, expression tracing, autograd, dependency changes in published crates, version bump, tag, publish, or companion maturity changes.
