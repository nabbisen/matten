...
| **Post-v0.37.0** | Report-tool policy and maintainability | RFC-070 public-readiness audit and RFC-072 modularization closed; RFC-073 proposes bounded private input-mode data-readiness JSON, with implementation and release undecided | Policy-first decision |
...
Proposed RFC-073 is now the policy-first decision for bounded private
data-readiness input-mode JSON. It distinguishes reportable strict-conversion
success/error outcomes from ingestion, selection, serialization, and I/O
command failures; requires structured user-data bounds; and preserves private
schema version 0. Implementation still requires RFC acceptance and a reviewed
detailed handoff. Public JSON schemas, SVG, and Vega-Lite remain deferred.
