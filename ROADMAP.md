...
**Document Version:** `1.64.0`
**Date:** 2026-07-15
**Status:** Canonical roadmap updated for the RFC-068 shared educational report data implementation-review slice. The implementation extracts one private fixed educational-path data model shared by the Markdown and HTML renderers in `tools/matten-report`, preserving byte-identical Markdown and HTML output and adding an exact HTML output snapshot test. This does not authorize new output formats, public report/viz crates, core visualization APIs, expression tracing, autograd, dependency changes in published crates, version bump, tag, publish, or companion maturity changes.
