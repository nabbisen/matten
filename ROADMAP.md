...
| **Post-v0.36.0** | Public visualization/report readiness | RFC-070 readiness audit drafted: public `matten-report` / `matten-viz` not ready; private report-model extraction implementation prepared for review as behavior-neutral local-tool helper extraction; JSON schema policy remains separate future review | Audit / planning |
