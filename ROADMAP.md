...
| **Post-v0.38.0** | v1.0 readiness re-audit | RFC-074 proposed as an audit-only re-run of RFC-066: eight releases (`0.31.0` -> `0.38.0`) shipped zero published-crate change; re-measures public-API stability, deferred stats/linalg/streaming as v1-blocking or post-v1, companion maturity promotion, and whether RFC-030 lock-step versioning still serves the family | Audit-only; no implementation, version bump, or release authorized |
