...
**Date:** 2026-07-22
**Status:** `0.37.0` is released with the RFC-071 fixed-demo private JSON report slice. RFC-070 is closed without a public report/viz crate or API. RFC-072 Slice 0, Slice 1, Phase 2, and the first Phase 3 shared/data-readiness Markdown checkpoint are reviewed and committed. The remaining four fixed-demo Markdown renderers and their exact tests now live in family-owned `render::markdown` modules and are prepared for one review. All 59 tests and the 404-byte process fingerprint remain unchanged. HTML, JSON, and later structural work remain unauthorized until this Markdown checkpoint is reviewed and committed. Input-mode JSON, broader mathematics, ecosystem bridges, public schemas, public renderer APIs, and public report/viz crates remain unauthorized.
...
| **Post-v0.37.0** | RFC-070 closure and report-tool maintainability | RFC-070 closed without a public report/viz surface; RFC-072 Slice 0/1, Phase 2, and shared/data-readiness Markdown committed; remaining fixed-demo Markdown extraction prepared for review | Implementation checkpoint |
...
committed. The remaining fixed-demo Markdown families are implemented in their
format/family owners and prepared for one review before HTML extraction.
